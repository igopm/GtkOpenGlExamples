...
void OpenglWindow::draw_cub(){
    ...
    GLint modelLoc = glGetUniformLocation(shaderCub.prog, "model");
    GLint viewLoc = glGetUniformLocation(shaderCub.prog, "view");
    GLint projLoc = glGetUniformLocation(shaderCub.prog, "projection");
...
void OpenglWindow::init_shaders(){
    ...
    shaderCub = Shader::fromFiles("shaders/cub.vert","shaders/cub.frag" );
}
//=====================================================================================================
